...
The flow progressed smoothly until routing. Congestion in the design prevented global and detailed routing from completing successfully. All logs, reports, and intermediate databases have been saved for analysis and debugging.
